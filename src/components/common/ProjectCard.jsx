...
const ProjectCard = ({ name, GitHub, live, image, description, alt }) => {
  return (
    <div>
      <div
        className='max-w-sm   md:w-72   lg:w-80 h-[620px]  bg-stone-50 border border-gray-200 rounded-lg 
        shadow-md   transform transition duration-500 md:hover:scale-110  hover:scale-105 '
      >
