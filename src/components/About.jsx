        ...
        <div className='flex-1   '>
          ...
          <div className='text-lg text-gray-500 tracking-normal font-normal leading-7 mb-3 '>
            <p>
              ...
              believe that as a developer, it's your responsibility to build a
              bridge between creativity and functionality, and create seamless
              user experiences. You can find some of my work in the{' '}
              <span className='font-semibold  text-gray-600 '>
                {' '}
                projects
              </span>{' '}
